...
public struct GetTipAmountsDefaultUseCase: GetTipAmountsUseCase {
    ...
    public func execute() async -> Result<TipAmounts, Error> {
        do {
            let data = try await repository.provideGetTipAmounts()
