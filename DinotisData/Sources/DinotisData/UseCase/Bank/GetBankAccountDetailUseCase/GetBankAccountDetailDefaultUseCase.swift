...
public struct GetBankAccountDetailDefaultUseCase: GetBankAccountDetailUseCase {
    ...
    public func execute(for id: Int) async -> Result<BankAccountData, Error> {
        do {
            let data = try await repository.provideGetBankAccountDetail(by: id)
