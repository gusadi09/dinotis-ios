...
public struct GetTransactionHistoryDefaultUseCase: GetTransactionHistoryUseCase {
    ...
    public func execute() async -> Result<HistoryTransactionResponse, Error> {
        do {
            let data = try await repository.provideGetTransactionHistory()
