...
public struct GetWithdrawBankListDefaultUseCase: GetWithdrawBankListUseCase {
    ...
    public func execute() async -> Result<BankResponse, Error> {
        do {
            let data = try await repository.provideGetListOfAvailableBank()
