...
public struct WithdrawalTransactionDetailDefaultUseCase: WithdrawalTransactionDetailUseCase {
    ...
    public func execute(with id: String) async -> Result<WithdrawDetailResponse, Error> {
        do {
            let data = try await repository.provideGetWithdrawTransactionDetail(with: id)
