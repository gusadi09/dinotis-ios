...
public struct GetSecondBannerDefaultUseCase: GetSecondBannerUseCase {
    ...
    public func execute() async -> Result<BannerResponse, Error> {
        do {
            let data = try await repository.provideGetSecondBanner()
