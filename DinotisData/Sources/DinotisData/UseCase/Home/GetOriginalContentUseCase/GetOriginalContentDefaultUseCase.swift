...
public struct GetOriginalContentDefaultUseCase: GetOriginalContentUseCase {
    ...
    public func execute() async -> Result<OriginalSectionResponse, Error> {
        do {
            let data = try await repository.provideGetOriginalSection()
