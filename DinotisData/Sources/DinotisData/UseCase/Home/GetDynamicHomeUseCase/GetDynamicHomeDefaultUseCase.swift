...
public struct GetDynamicHomeDefaultUseCase: GetDynamicHomeUseCase {
    ...
    public func execute() async -> Result<DynamicHomeResponse, Error> {
        do {
            let data = try await repository.provideGetDynamicHome()
