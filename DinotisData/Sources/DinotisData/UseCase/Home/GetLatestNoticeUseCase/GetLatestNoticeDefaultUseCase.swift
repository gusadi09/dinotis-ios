...
public struct GetLatestNoticeDefaultUseCase: GetLatestNoticeUseCase {
    ...
    public func execute() async -> Result<LatestNoticesResponse, Error> {
        do {
            let data = try await repository.provideGetLatestNotice()
