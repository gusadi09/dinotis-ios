...
public struct GetCounterDefaultUseCase: GetCounterUseCase {
    ...
    public init(
        repository: CounterRepository = CounterDefaultRepository(),
    ...
    public func execute() async -> Result<CounterResponse, Error> {
        do {
            let data = try await repository.provideGetCounter()
