...
public struct GetRateCardDefaultUseCase: GetRateCardUseCase {
	...
	public func execute(with params: GeneralParameterRequest) async -> Result<RateCardListResponse, Error> {
		do {
			let data = try await repository.provideGetRateCardList(by: params)
