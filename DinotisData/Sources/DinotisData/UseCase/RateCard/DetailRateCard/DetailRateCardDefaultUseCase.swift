...
public struct DetailRateCardDefaultUseCase: DetailRateCardUseCase {
	...
	public func execute(for id: String) async -> Result<RateCardResponse, Error> {
		do {
			let data = try await repository.provideGetDetailRateCard(by: id)
