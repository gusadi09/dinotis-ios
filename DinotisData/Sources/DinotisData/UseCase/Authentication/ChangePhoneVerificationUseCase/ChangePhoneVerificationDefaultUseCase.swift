...
public struct ChangePhoneVerificationDefaultUseCase: ChangePhoneVerificationUseCase {
    ...
    public func execute(with params: OTPVerificationRequest) async -> Result<UserResponse, Error> {
        do {
            let data = try await repository.changePhoneVerification(by: params)
