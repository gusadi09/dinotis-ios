...
public struct GetDetailVideoDefaultUseCase: GetDetailVideoUseCase {
    ...
    public func execute(for id: String) async -> Result<DetailVideosResponse, Error> {
        do {
            let data = try await repository.provideGetDetailVideo(on: id)
