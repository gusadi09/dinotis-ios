...
public struct GetCreatorMeetingWithStatusListDefaultUseCase: GetCreatorMeetingWithStatusListUseCase {
    ...
    public func execute(with params: MeetingsStatusPageRequest) async -> Result<CreatorMeetingWithStatusResponse, Error> {
        do {
            let data = try await repository.provideGetTalentMeetingWithStatus(params: params)
