...
public struct GetCreatorMeetingListDefaultUseCase: GetCreatorMeetingListUseCase {
    ...
    public func execute(with params: MeetingsPageRequest) async -> Result<TalentMeetingResponse, Error> {
        do {
            let data = try await repository.provideGetTalentMeeting(params: params)
