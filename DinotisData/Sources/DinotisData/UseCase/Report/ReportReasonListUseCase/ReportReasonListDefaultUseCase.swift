...
public struct ReportReasonListDefaultUseCase: ReportReasonListUseCase {
    ...
    public func execute() async -> Result<ReportReasonResponse, Error> {
        do {
            let data = try await repository.provideGetReportReason()
