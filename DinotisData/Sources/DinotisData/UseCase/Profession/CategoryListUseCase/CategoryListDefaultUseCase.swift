...
public struct CategoryListDefaultUseCase: CategoryListUseCase {
    ...
    public func execute() async -> Result<CategoriesResponse, Error> {
        do {
            let data = try await repository.provideGetCategory()
