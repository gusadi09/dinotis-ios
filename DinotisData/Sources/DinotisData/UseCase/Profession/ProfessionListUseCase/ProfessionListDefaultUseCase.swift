...
public struct ProfessionListDefaultUseCase: ProfessionListUseCase {
    ...
    public func execute() async -> Result<ProfessionResponse, Error> {
        do {
            let data = try await repository.provideGetProfession()
