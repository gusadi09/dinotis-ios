...
public struct GetAvailableMeetingDefaultUseCase: GetAvailableMeetingUseCase {
    ...
    public func execute() async -> Result<AvailableMeetingResponse, Error> {
        do {
            let data = try await bundlingRepository.provideGetAvailableMeeting()
