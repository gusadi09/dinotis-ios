...
public struct DeleteBundlingDefaultUseCase: DeleteBundlingUseCase {
    ...
    public func execute(by bundleId: String) async -> Result<CreateBundlingResponse, Error> {
        do {
            let data = try await bundlingRepository.provideDeleteBundling(by: bundleId)
